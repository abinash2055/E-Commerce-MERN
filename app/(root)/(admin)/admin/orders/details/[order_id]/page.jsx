                                        ...
                                        <table className='w-full'>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td
                                                        className="text-end py-2">
                                                        {orderData?.subtotal.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td
                                                    ...
                                                    <td
                                                        className="text-end py-2">
                                                        {orderData?.discount.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        className="text-end py-2">
                                                        {orderData?.totalAmount.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
