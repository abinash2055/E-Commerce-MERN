                                    ...
                                    <tr
                                        ...
                                        <td className="md:table-cell flex justify-between md:p-3 px-3 pb-2">
                                            ...
                                            <div className='flex justify-center'>
                                                <div className="flex justify-center items-center border md:h-10 h-7 w-fit rounded-full">
                                ...
                                <table className='w-full'>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td className="text-end py-2">
                                                {(subtotal - discount).toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}
