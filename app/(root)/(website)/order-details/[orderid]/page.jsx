...
const OrderDetails = async ({ params }) => {
    ...
    return (
        <div>
            <WebsiteBreadcrumb props={breadcrum} />
                                    ...
                                    <table className='w-full'>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td
                                                    className="text-end py-2">
                                                    {orderData?.data?.subtotal.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                ...
                                                <td
                                                    className="text-end py-2">
                                                    {orderData?.data?.discount.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    className="text-end py-2">
                                                    {orderData?.data?.totalAmount.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
