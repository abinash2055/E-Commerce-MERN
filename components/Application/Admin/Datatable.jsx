...
const Datatable = ({
    ...
    // Default createdAction if not provided
    const defaultCreatedAction = (row, deleteType, handleDelete) => [
        <MenuItem key="edit" onClick={() => alert(`Editing ${row.original._id}`)}>Edit</MenuItem>,
        <MenuItem key="delete" onClick={() => handleDelete([row.original._id], deleteType)}>Delete</MenuItem>
    ]
    ...
    const table = useMaterialReactTable({
        ...
        renderRowActionMenuItems: ({ row }) =>
            (createdAction || defaultCreatedAction)(row, deleteType, handleDelete),
