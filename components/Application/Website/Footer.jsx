...
const Footer = () => {
  return (
    <footer className='bg-gray-50 border-t'>
      <div
        className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-10 py-10 lg:px-32 px-4">
        ...
        <div className="lg:col-span-1 md:col-span-2 col-span-1">
          ...
          <p className="text-gray-500 text-sm">
            E-store is your trusted destination for quality and convenience. From fashion to essentials, we bring everything you need right to your doorstep. Stop, smart, ive better - only at E-store.
          </p>
        </div>
          ...
          <ul>
            <li className="mb-2 text-gray-500 flex gap-2">
              ...
              <span className='text-sm'>
                E-store market Kapilvastu, Nepal 32800
              </span>
            </li>
            <li className="mb-2 text-gray-500 flex gap-2">
      ...
      <div className="py-5 bg-gray-100">
        <p className='text-center'> © 2025 Estore. All Rights Reversed.</p>
      </div>
    </footer>
  )
}
